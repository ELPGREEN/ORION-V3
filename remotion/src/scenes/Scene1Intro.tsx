...
export const Scene1Intro = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#06080e", justifyContent: "center", alignItems: "center" }}>
      ...
      <div style={{ marginTop: 40, opacity: orionOpacity, transform: `translateX(${interpolate(orionX, [0, 1], [-80, 0])}px)` }}>
        <span style={{ fontFamily: orbitron, fontSize: 96, fontWeight: 900, color: "white", letterSpacing: 24, textShadow: "0 0 40px rgba(0,212,255,0.3)" }}>
          ORION
        </span>
      </div>

      <div style={{ marginTop: 16, opacity: subOpacity, transform: `translateY(${subY}px)` }}>
        <span style={{ fontFamily: inter, fontSize: 22, fontWeight: 300, color: "rgba(255,255,255,0.6)", letterSpacing: 12, textTransform: "uppercase" as const }}>
          Inteligência Artificial Empresarial
        </span>
      </div>

      <div style={{ marginTop: 40, opacity: tagOpacity }}>
        <div style={{ padding: "10px 32px", border: "1px solid rgba(0,212,255,0.3)", background: "rgba(0,212,255,0.05)" }}>
          <span style={{ fontFamily: inter, fontSize: 14, fontWeight: 400, color: "#00d4ff", letterSpacing: 6, textTransform: "uppercase" as const }}>
