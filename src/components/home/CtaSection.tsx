...
import { ArrowRight, Brain, Users, FileText, Zap } from "lucide-react";
import { Button } from "@/components/ui/button";
import { ScrollReveal } from "@/components/ui/ScrollReveal";

const socialProof = [
  { icon: Users, value: "Empresas", label: "de 8+ países" },
  { icon: FileText, value: "100+", label: "tipos de documentos" },
  { icon: Zap, value: "40+", label: "automações ativas" },
];
