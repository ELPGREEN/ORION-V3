...
import orionLogo from "@/assets/orion-splash-logo-circle.png";
            ...
            <div className="relative z-10 flex flex-col items-center gap-6 px-6 text-center max-w-lg">
              ...
              >
                <img
                  ...
                  className="w-48 h-48 sm:w-60 sm:h-60 md:w-72 md:h-72 object-contain rounded-full drop-shadow-[0_0_40px_rgba(212,175,55,0.4)]"
                />
              </motion.div>
