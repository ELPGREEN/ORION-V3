...
const PRESETS: FormatPreset[] = [
  // Padrões Brasileiros - Formatação Jurídica Oficial
  {
    id: "juridico-br",
    label: "Formatação Jurídica BR",
    category: "Jurídico",
    fontFamily: "Arial",
    fontSize: "12pt",
    lineHeight: "1.5",
    ...
    description: "Arial 12pt, 1.5, justificado, recuo 1.25cm, margens 3cm esq",
  },
  {
    id: "peticao",
    ...
    textAlign: "justify",
    standard: "CNJ",
    description: "Arial 12pt, 1.5, justificado, recuo 1.25cm, títulos centralizados",
  },
  {
    id: "contrato",
    label: "Contrato",
    ...
    lineHeight: "1.5",
    textAlign: "justify",
    description: "Arial 12pt, 1.5, justificado, cláusulas numeradas",
  },
  {
    id: "parecer",
    ...
    textAlign: "justify",
    standard: "OAB",
    description: "Arial 12pt, 1.5, justificado, seções com numeração",
  },
  {
    id: "sentenca",
    ...
    textAlign: "justify",
    standard: "CNJ",
    description: "Arial 12pt, espaçamento duplo, justificado",
  },
  {
    id: "recurso",
    ...
    lineHeight: "1.5",
    textAlign: "justify",
    description: "Arial 12pt, 1.5, justificado, recuo 1.25cm",
  },
  // ABNT
  {
    id: "abnt",
