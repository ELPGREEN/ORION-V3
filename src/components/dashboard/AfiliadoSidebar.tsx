...
import {
  Link2, ShoppingBag, DollarSign, Brain, Settings, Bell, LogOut,
  Globe, Crown, FileText, BarChart3, Image, HelpCircle,
} from "lucide-react";
...
const afiliadoItems = [
  ...
  { id: "meu-site", label: "Perfil Público", icon: Globe, path: "/dashboard/escritorio" },
