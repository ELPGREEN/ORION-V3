...
const ONBOARDING_STEPS = [
  {
    id: "welcome",
    title: "Bem-vindo à Configuração",
  ...
  },
  {
    ...
    icon: Sparkles,
    voicePrompt: "Qual personalidade você prefere? Profissional, amigável, técnica ou personalizada? Diga sua escolha.",
  },
  {
    id: "wake_word",
    title: "Palavra de Ativação",
    description: "Escolha o nome que vai usar para me chamar.",
    icon: Ear,
    voicePrompt: "Qual nome você quer usar para me chamar? O padrão é Ana. Diga o nome que preferir.",
  },
  {
    id: "voice",
    title: "Configuração de Voz",
    description: "Ajuste velocidade e tom da minha voz.",
    icon: Volume2,
  ...
  },
  {
    ...
    description: "Configure como eu analiso imagens e câmera.",
    icon: Eye,
    voicePrompt: "Quer ativar meu sistema de visão? Eu posso identificar objetos, ler documentos e muito mais. Diga sim ou não.",
  },
  {
    id: "instructions",
    title: "Instruções Mestras",
    description: "Defina regras de comportamento personalizadas.",
    icon: Command,
    voicePrompt: "Agora você pode me dar instruções especiais. Por exemplo: sempre responda em tópicos, ou foque em direito trabalhista. Diga suas instruções ou pule esta etapa.",
  },
  {
    id: "complete",
    title: "Configuração Completa!",
    description: "Sua IA está pronta para uso.",
    icon: Check,
    voicePrompt: "Configuração concluída! Estou pronta para te ajudar. Todas as suas preferências foram salvas.",
  },
];
