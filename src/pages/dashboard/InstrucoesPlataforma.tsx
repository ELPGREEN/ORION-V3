...
const allSections: Section[] = [
  ...
  },
  {
    ...
    voiceCommands: [
      ...
      // Vídeo
      '"Orion, tocar música" — reproduz música no YouTube/Spotify',
      '"Orion, pausar" — pausa o vídeo ou música',
      '"Orion, continuar" — continua reprodução',
      '"Orion, aumentar a tela" — tela cheia do vídeo',
      '"Orion, diminuir a tela" — sai da tela cheia',
      '"Orion, minimizar o vídeo" — minimiza o player',
      '"Orion, abrir pesquisa"',
  ...
  },
  {
    ...
    steps: [
      ...
      "Ative/desative a visão por comando de voz a qualquer momento.",
    ],
    voiceCommands: [
      ...
      '"Orion, ativar visão" — ativa a câmera e análise visual',
      '"Orion, desativar visão" — desativa a câmera e para análise',
      '"Orion, como eu estou?" — análise de aparência facial',
      '"Orion, o que tem na tela?" — descreve elementos visíveis',
    ],
    faq: [
      ...
      { q: "Posso controlar a visão por voz?", a: "Sim! Diga \"ativar visão\" ou \"desativar visão\" a qualquer momento." },
    ],
  },
